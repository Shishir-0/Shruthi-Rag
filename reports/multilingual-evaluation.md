...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Hindi (हिंदी)** | `hi` | `आयुष्मान भारत डिजिटल मिशन क्या है?` | `hi` | `5` | **GROUNDED** | `2.266 ms` | **OK** |
| **Gujarati (ગુજરાતી)** | `gu` | `ગિફ્ટ સિટી ગાંધીનગર ક્યાં આવેલું છે?` | `gu` | `5` | **GROUNDED** | `0.484 ms` | **OK** |
| **Bengali (বাংলা)** | `bn` | `সুন্দরবন ম্যানগ্রোভ বন কোথায় অবস্থিত?` | `bn` | `5` | **GROUNDED** | `0.366 ms` | **OK** |
| **Tamil (தமிழ்)** | `ta` | `தஞ்சாவூர் பிருகதீஸ்வரர் கோவில் யார் கட்டியது?` | `ta` | `5` | **GROUNDED** | `0.282 ms` | **OK** |
| **English** | `en` | `What is the renewable energy target of India by 2030?` | `en` | `5` | **GROUNDED** | `0.314 ms` | **OK** |
